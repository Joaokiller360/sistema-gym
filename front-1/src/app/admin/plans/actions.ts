...
export async function updateSubscriptionPlanAction(
  id: string,
  data: { label?: string; price?: string | number; currency?: string; maxMembers?: number | null; storeEnabled?: boolean; demoEnabled?: boolean; trialEnabled?: boolean; advancedReportsEnabled?: boolean; features?: string[]; isActive?: boolean },
  planKey?: string,
...
export async function createSubscriptionPlanAction(
  data: { key: string; label: string; price: string | number; currency: string; maxMembers?: number | null; storeEnabled?: boolean; demoEnabled?: boolean; trialEnabled?: boolean; advancedReportsEnabled?: boolean; features?: string[] },
): Promise<{ error?: string }> {
  const token = await getToken()
